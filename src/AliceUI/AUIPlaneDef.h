...
struct AUIPlane
{
    ...
    AUIPlane() : vCenter(0, 0, 0), vNorm(0, 0, 1), vRef(1, 0, 0), fAlpha(0.8f), fLineThickness(4.0f), type(PLANE_DRAWING_TYPE_FACE) { arMargin[0] = 20; arMargin[1] = 20; }

    static AUIPlane Make() { return AUIPlane(); }
