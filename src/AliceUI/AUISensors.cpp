...
bool MAUISensorUtil::IsIntersectArc(const glm::vec3& vRayOrg, const glm::vec3& vRayDir, float fRayRad, const AUIShapeArc& arc, float& fHitDistance)
{
...
bool MAUISensorUtil::IsIntersectEllipse(const glm::vec3& vRayOrg, const glm::vec3& vRayDir, float fRayRad, const AUIShapeEllipse& ellipse, float& fHitDistance)
{
    return false;
}

bool MAUISensorUtil::IsIntersectEllipseArc(const glm::vec3& vRayOrg, const glm::vec3& vRayDir, float fRayRad, const AUIShapeEllipseArc& ellipseArc, float& fHitDistance)
{
    return false;
}
