...
void AUIRulerDrawable::OnDraw( SkCanvas* const canvas )
{
    switch ( GetLocation() )
    {
...
void AUIRulerDrawable::OnDrawLeft( SkCanvas* const canvas )
{
...
void AUIRulerDrawable::OnDrawTop( SkCanvas* const canvas )
{
    const auto rect = GetDrawBound();
    const auto padding = GetDrawPadding();
    const auto linePaint = RefLinePaint();
...
void AUIRulerDrawable::OnDrawRight( SkCanvas* const canvas )
{
    const auto rect = GetDrawBound();
    const auto padding = GetDrawPadding();
    const auto linePaint = RefLinePaint();
...
void AUIRulerDrawable::OnDrawBottom( SkCanvas* const canvas )
{
    const auto rect = GetDrawBound();
    const auto padding = GetDrawPadding();
    const auto linePaint = RefLinePaint();
